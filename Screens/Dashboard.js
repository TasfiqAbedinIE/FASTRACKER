    ...
    for (const i of value) {
      axios
        ...
        .then((res) => {
          ...
          totalTarget.push(counter * target);
          // console.log("Achievement: " + (hourProd/(counter * target)*100))
          totalProd.push(hourProd);
          lineProd.push(tempProd);
          setProduction([...lineProd]);
          setLineWiseProduction([...totalProd]);
          setLineWiseTarget([...totalTarget]);
          setNumLine([...iniNumLine])
        });
  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.chartArea}>
        ...
        >
          {production.map((e, index) => {
            // console.log(lineWiseProduction[index])
            // console.log(lineWiseTarget[index])
            return (
              <View>
                <View style={styles.lineTextContainer}>
                  <Text style={styles.lineText}>Line No: {numLine[index]}</Text>
                </View>
                <View>
                  <BarChart
                    style={{
                ...
                <View style={styles.reportContainer}>
                  <View>
                    <Text style={styles.reportText}>Total Production: {lineWiseProduction[index]}</Text>
                  </View>
