            ...
            <ScrollView style={styles.scrollview}>
                ...
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.dataContainer}>
                        <View style={styles.datafield}>
                            <Text style={styles.text}>TARGET</Text>
                            <TextInput style={styles.textInput} keyboardType='numeric' onChangeText={getTarget_8}></TextInput>
                        </View>
                        <View style={styles.datafield}>
                            <Text style={styles.text}>PRODUCTION</Text>
                            <TextInput style={styles.textInput} keyboardType='numeric' onChangeText={getProduction_8}></TextInput>
                        </View>
                    </View>
                    <View style={styles.dataformbundle}>
                        <Text style={styles.text}>REMARKS</Text>
                        <TextInput style={[styles.textInput, {width: screen_width*0.92}]} onChangeText={getIssue_8}></TextInput>
                    </View>
                </View>
                {/* ////// 9 ////// */}
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.dataContainer}>
                        <View style={styles.datafield}>
                            <Text style={styles.text}>TARGET</Text>
                            <TextInput style={styles.textInput} keyboardType='numeric' onChangeText={getTarget_9}></TextInput>
                        </View>
                        <View style={styles.datafield}>
                            <Text style={styles.text}>PRODUCTION</Text>
                            <TextInput style={styles.textInput} keyboardType='numeric' onChangeText={getProduction_9}></TextInput>
                        </View>
                    </View>
                    <View style={styles.dataformbundle}>
                        <Text style={styles.text}>REMARKS</Text>
                        <TextInput style={[styles.textInput, {width: screen_width*0.92}]} onChangeText={getIssue_9}></TextInput>
                    </View>
                </View>
                {/* ////// 10 ////// */}
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.dataContainer}>
                        <View style={styles.datafield}>
                            <Text style={styles.text}>TARGET</Text>
                            <TextInput style={styles.textInput} keyboardType='numeric' onChangeText={getTarget_10}></TextInput>
                        </View>
                        <View style={styles.datafield}>
                            <Text style={styles.text}>PRODUCTION</Text>
                            <TextInput style={styles.textInput} keyboardType='numeric' onChangeText={getProduction_10}></TextInput>
                        </View>
                    </View>
                    <View style={styles.dataformbundle}>
                        <Text style={styles.text}>REMARKS</Text>
                        <TextInput style={[styles.textInput, {width: screen_width*0.92}]} onChangeText={getIssue_10}></TextInput>
                    </View>
                </View>
